...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', function () {
    navigator.serviceWorker.register('/jortec-pwa/_service-worker.js', { scope: '/jortec-pwa/' });
  });
}
...
$(document).ready(function () {
  ...
  var pwaVersion = '0.0.13'; //must be identical to _manifest.json version. If not it will create update window loop
  ...
  function createShortCookie(e, t, n) { if (n) { var o = new Date; o.setTime(o.getTime() + n * 60 * 1e3); var r = "; expires=" + o.toGMTString() } else var r = ""; document.cookie = e + "=" + t + r + "; path=/" }
    ...
    if ($('link[data-pwa-version]').length) {
      function versionCheck() {
        ...
        setTimeout(function () {
          ...
          if (onlineVersionNumber != localVersionNumber && onlineVersionNumber != "Connection Offline. Waiting to Reconect" && readCookie("justUpdated") == undefined) {
            updateModal();
            ...
            setTimeout(function () {
              ...
              updateButton();
              createShortCookie("justUpdated", true, 15);
            }, 500);
          }
